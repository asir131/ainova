...
export default function HowItWorksSection() {
  ...
  return (
    <section  id="how-it-works" className="relative md:h-screen py-16 sm:py-20 lg:py-24 xl:py-28 bg-gradient-to-br from-[#CEE1FF] via-white to-[#CEE1FF]">
      <div className= "flex flex-col items-center xl:ml-20 justify-around text-center  mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
        {/* Header */}
        ...
        <div className="grid md:grid-cols-2 xl:ml-30  grid-col-reverse lg:grid-cols-[1fr_480px] xl:grid-cols-[1fr_520px] gap-12 lg:gap-20 xl:gap-50 items-center">
          {/* Steps + Numbers */}
